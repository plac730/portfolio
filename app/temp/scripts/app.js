...
new _RevealOnScroll2.default((0, _jquery2.default)('.block-content__screenshot'), "reveal-item-slow", "75%");
...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.homeLink = (0, _jquery2.default)('.primary-nav__home');
    this.events();
  }
...
var RevealOnScroll = function () {
  function RevealOnScroll(els, speed, offset) {
  ...
  _createClass(RevealOnScroll, [{
    ...
    key: 'createWaypoints',
    value: function createWaypoints(speed, offset) {
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            ...
            (0, _jquery2.default)(currentItem).addClass(speed);
          },
          offset: offset
        });
      });
